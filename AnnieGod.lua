-- WELCOME TO A PROPER REWORK OF ANNIE

-- CREDITS TO : VTNEET
-- USE MIXLIB, OP LIBRARY
...
if myHero.charName == "Annie" then GAnnie() else PrintChat("GAnnie didn't support for "..myHero.charName) return end
