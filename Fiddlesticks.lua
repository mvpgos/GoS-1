...
function AutoUpdate(data)
    if tonumber(data) > tonumber(ver) then
        ...
        DownloadFileAsync("https://github.com/estruptum/GoS/blob/master/Fiddlesticks.lua", SCRIPT_PATH .. "Fiddlesticks.lua", function() PrintChat("Update Complete, please 2x F6!") return end)
    else
